...
background = pygame.image.load("v3/imagens/background.png")
...
class Jogador(Entidade):
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load("v3/imagens/naveDoJogo.png") # verde
        self.vida = 5
...
class RoboZigueZague(Robo):
    def __init__(self, x, y):
        ...
        self.direcao = 1
        self.image = pygame.image.load("v3/imagens/robo_ziguezague.png")
...
class RoboLento(Robo):
    def __init__(self, x, y):
        super().__init__(x, y, velocidade=3)
        self.direcao = 1
        self.image = pygame.image.load("v3/imagens/robo_lento.png")
        self.image = pygame.transform.scale(self.image, (70, 70))
...
class RoboRapido(Robo):
    def __init__(self, x, y):
        super().__init__(x, y, velocidade=3)
        self.direcao = 1
        self.image = pygame.image.load("v3/imagens/robo_rapido.png")
        self.image = pygame.transform.scale(self.image, (70, 70))
...
class RoboCacador(Robo):
    def __init__(self, x, y, alvo):
        super().__init__(x, y, velocidade=3)
        self.direcao = 1
        self.image = pygame.image.load("v3/imagens/robo_cacador.png")
        self.image = pygame.transform.scale(self.image, (70, 70))
        self.alvo = alvo
...
class RoboChefao(Robo):
    def __init__(self, x, y):
        super().__init__(x, y, velocidade=3)
        self.image = pygame.image.load("v3/imagens/robo_chefao.png")
        self.image = pygame.transform.scale(self.image, (70, 70))
        self.vida = 30
        self.tipo = "chefao"
    def atualizar_posicao(self):
...
class VidaExtra(Entidade):
    def __init__(self, x, y):
        super().__init__(x, y, velocidade=3)
        self.tipo = "vida"
        self.image = pygame.image.load("v3/imagens/buff cura.png")
        self.image = pygame.transform.scale(self.image, (70, 70))
        self.direcao = 1
...
class Velocidade(Entidade):
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load("v3/imagens/buff energia.png")
...
class TiroTriplo(Entidade):
    def __init__(self, x, y):
        super().__init__(x, y, velocidade=3)
        self.tipo = "tiro"
        self.image = pygame.image.load("v3/imagens/buff municao.png")
        self.image = pygame.transform.scale(self.image, (70*2, 70*2))
        self.direcao = 1
...
coracao = pygame.image.load("v3/imagens/coracao.png")
coracao = pygame.transform.scale(coracao, (32, 32))
coracao_vazio = pygame.image.load("v3/imagens/coracao_vazio.png")
