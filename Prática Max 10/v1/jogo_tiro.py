...
class RoboZigueZague(Robo):
    def __init__(self, x, y):
        ...
        self.direcao = 1
        self.image = pygame.image.load("v1/imagens/robo_ziguezague.png")
...
class RoboLento(Robo):
    def __init__(self, x, y):
        super().__init__(x, y, velocidade=3)
        self.direcao = 1
        self.image = pygame.image.load("v1/imagens/robo_lento.png")
        self.image = pygame.transform.scale(self.image, (70, 70))
...
class RoboRapido(Robo):
    def __init__(self, x, y):
        super().__init__(x, y, velocidade=3)
        self.direcao = 1
        self.image = pygame.image.load("v1/imagens/robo_rapido.png")
        self.image = pygame.transform.scale(self.image, (70, 70))
...
class RoboCiclico(Robo):
    def __init__(self, x, y):
        super().__init__(x, y, velocidade=3)
        self.image = pygame.image.load("v1/imagens/robo_ciclico.png")
        self.image = pygame.transform.scale(self.image, (70, 70))
...
class RoboCacador(Robo):
    def __init__(self, x, y, alvo):
        super().__init__(x, y, velocidade=3)
        self.direcao = 1
        self.image = pygame.image.load("v1/imagens/robo_cacador.png")
        self.image = pygame.transform.scale(self.image, (70, 70))
        self.alvo = alvo
    ...
    def atualizar_posicao(self):
        ...
        elif self.rect.x +1 == self.alvo.rect.x:
...
class RoboChefao(Robo):
    def __init__(self, x, y):
        super().__init__(x, y, velocidade=3)
        self.image = pygame.image.load("v1/imagens/robo_chefao.png")
        self.image = pygame.transform.scale(self.image, (70, 70))
        self.vida = 30
        self.tipo = "chefao"
    def atualizar_posicao(self):
...
class VidaExtra(Entidade):
    def __init__(self, x, y):
        super().__init__(x, y, velocidade=3)
        self.tipo = "vida"
        self.image = pygame.image.load("v1/imagens/cura.png")
        self.image = pygame.transform.scale(self.image, (70, 70))
        self.direcao = 1
...
class Velocidade(Entidade):
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load("v1/imagens/velocidade.png")
        self.image = pygame.transform.scale(self.image, (70, 70))
        self.direcao = 1
...
class TiroTriplo(Entidade):
    def __init__(self, x, y):
        super().__init__(x, y, velocidade=3)
        self.tipo = "tiro"
        self.image = pygame.image.load("v1/imagens/triplo.png")
        self.image = pygame.transform.scale(self.image, (70, 70))
        self.direcao = 1
...
while rodando:
    ...
    if spawn_timer > 400:
        ...
        todos_sprites.add(velo,t_triplo)
        inimigos.add()
